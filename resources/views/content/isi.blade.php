...
@foreach ($semua as $s)
	<div class="col-md-3">
		<a href="{{route('page.show_news',$s->id)}}" style="color: black;text-decoration: none;">
...
<div class="row">
	<div class="col-md-8">
		...
		<div class="panel">
			...
			@foreach($olahraga as $o)
				<div class="row">
					<a href="{{route('page.show_news',$o->id)}}" style="color: black">
						<div class="col-md-3">
			...
			<div class="row">
				<a href="{{route('page.show_news',$p->id)}}" style="color: black">
					<div class="col-md-3">
			...
			<!-- tekonologi -->
			<br>
			<b class="label label-info"><b>TEKNOLOGY NEWS</b></b>
			<hr>
			@foreach($tekno as $tek)
			<div class="row">
				<a href="{{route('page.show_news',$tek->id)}}" style="color: black">
					<div class="col-md-3">
	...
	<div class="col-md-4">
		...
		<div class="row">
		@foreach($tops as $tp)
			<a href="{{route('page.show_news',$tp->id)}}" style="color: black">
				<div class="col-md-6">
					<div class="panel panel-default">
					  <div class="panel-body">
